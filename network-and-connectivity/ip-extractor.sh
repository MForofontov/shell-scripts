#!/bin/bash
# filepath: /home/ummi/Documents/github/shell-scripts/network-and-connectivity/ip-extractor.sh
# ip-extractor.sh
...
log_message "Extracting IP addresses from $LOG_FILE..."
...
log_message "Extracted IPs saved to $OUTPUT_FILE"