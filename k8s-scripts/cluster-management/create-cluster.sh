...
usage() {
  ...
  echo -e "  \033[1;33m-n, --name\033[0m NAME          Cluster name (default: ${CLUSTER_NAME})"
  echo -e "  \033[1;33m-p, --provider\033[0m PROVIDER  Provider to use (minikube, kind, k3d) (default: ${PROVIDER})"
  echo -e "  \033[1;33m-c, --nodes\033[0m COUNT        Number of nodes (default: ${NODE_COUNT})"
  echo -e "  \033[1;33m-v, --version\033[0m VERSION    Kubernetes version (default: ${K8S_VERSION})"
  echo -e "  \033[1;33m-f, --config\033[0m FILE        Path to custom config file"
