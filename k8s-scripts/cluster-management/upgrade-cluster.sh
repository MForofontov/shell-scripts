...
usage() {
  ...
  echo -e "  \033[1;33m-p, --provider\033[0m PROVIDER   (Optional) Provider to use (minikube, kind, k3d) (default: ${PROVIDER})"
  ...
  echo -e "  \033[1;33m-t, --timeout\033[0m SECONDS     (Optional) Timeout in seconds for upgrade (default: ${WAIT_TIMEOUT})"
  echo -e "  \033[1;33m--log\033[0m FILE                (Optional) Log output to specified file"
