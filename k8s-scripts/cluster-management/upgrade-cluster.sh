...
usage() {
  ...
  echo -e "  \033[1;33m-n, --name\033[0m NAME          Cluster name to upgrade (required)"
  echo -e "  \033[1;33m-p, --provider\033[0m PROVIDER  Provider to use (minikube, kind, k3d) (default: ${PROVIDER})"
  echo -e "  \033[1;33m-v, --version\033[0m VERSION    Target Kubernetes version (required)"
  echo -e "  \033[1;33m-f, --force\033[0m              Force upgrade without confirmation"
  echo -e "  \033[1;33m--no-backup\033[0m              Skip backup/snapshot before upgrade"
  echo -e "  \033[1;33m-t, --timeout\033[0m SECONDS    Timeout in seconds for upgrade (default: ${WAIT_TIMEOUT})"
