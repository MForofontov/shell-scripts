#!/bin/bash
# filepath: /Users/mykfor1/Documents/git/github/shell-scripts/k8s-scripts/cluster-management/delete-cluster.sh
# delete-cluster.sh
...
usage() {
  ...
  echo -e "  \033[1;33m-n, --name\033[0m NAME          Cluster name to delete (required)"
  echo -e "  \033[1;33m-p, --provider\033[0m PROVIDER  Provider to use (minikube, kind, k3d) (default: ${PROVIDER})"
  echo -e "  \033[1;33m-f, --force\033[0m              Force deletion without confirmation"
