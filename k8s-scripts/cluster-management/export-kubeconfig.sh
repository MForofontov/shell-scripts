...
usage() {
  ...
  echo -e "  \033[1;33m-c, --context\033[0m CONTEXT       Export specified context"
  echo -e "  \033[1;33m-n, --name\033[0m NAME             Export config for cluster with this name"
  echo -e "  \033[1;33m-p, --provider\033[0m PROVIDER     Filter by provider (minikube, kind, k3d)"
  echo -e "  \033[1;33m-i, --interactive\033[0m           Select context interactively"
  echo -e "  \033[1;33m-o, --output\033[0m FILE           Output file (default: ./kubeconfig-CONTEXT.yaml)"
  echo -e "  \033[1;33m-s, --sanitize\033[0m              Remove sensitive data (tokens, passwords)"
  echo -e "  \033[1;33m-e, --expire\033[0m DURATION       Set credential expiry (e.g. 24h, 7d)"
  echo -e "  \033[1;33m--namespace\033[0m NAMESPACE       Set default namespace"
  echo -e "  \033[1;33m--user\033[0m USER                 Include only specified user credentials"
  echo -e "  \033[1;33m--merge\033[0m                     Merge with existing output file"
